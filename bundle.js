...
/***/ function(module, exports, __webpack_require__) {
	...
	var YOGEvents = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updategame = function updategame(data, id) {
	  return $.ajax({
	    url: api.host + '/games/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var postgame = function postgame(data) {
	  return $.ajax({
	    url: api.host + '/games',
	    method: 'POST',
	    data: data,
...
/***/ function(module, exports) {
	...
	var api = {
	  ...
	  host: "https://afternoon-stream-31070.herokuapp.com/"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(6);
	var indexGamesTemplate = __webpack_require__(8);
	...
	var getindexSuccess = function getindexSuccess(data) {
	...
	var postgameSuccess = function postgameSuccess(data) {
	  api.games = data.games;
	  success(data);
	  console.log(data);
	};
	...
	module.exports = {
	  ...
	  postgameSuccess: postgameSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<li>\n  <h4>"
	    ...
	    + "</h4>\n  <ul>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.editable : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </ul>\n  </li>\n\n<div class=\"modal fade\" id=\"EditModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n        <h4 class=\"modal-title\" id=\"myModalLabel\">Update the Game</h4>\n      </div>\n      <div class=\"modal-body\">\n        <form class=\"edit-form\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + ">\n          <div class=\"form-group\">\n            <label for=\"title\">Title</label>\n            <input type=\"text\" name=\"game[title]\"  placeholder=\"Title\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n          </div>\n          <div class=\"form-group\">\n            <label for=\"Category\">Category/Genre</label>\n            <input type=\"text\" name=\"game[category]\" placeholder=\"Category/Genre\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.category : stack1), depth0))
	    + "\">\n\n            <label for=\"Rating\">ESRB Rating</label>\n            <input type=\"text\" name=\"game[rating]\" placeholder=\"rating\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + "\">\n\n            <label for=\"Month\">Month</label>\n            <input type=\"text\" name=\"game[month]\" placeholder=\"month\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.month : stack1), depth0))
	    + "\">\n\n            <label for=\"Platform\">Platform</label>\n            <input type=\"text\" name=\"game[platform]\"  placeholder=\"platform\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.platform : stack1), depth0))
	  ...
	  return "  <li data-id="
	    ...
	    + " class=\"edit\" data-toggle=\"modal\" data-target=\"#EditModal"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Edit</li>\n    <li data-id="
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + " class=\"delete\">Delete</li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.games : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchGames = function searchGames(event) {
	  event.preventDefault();
	  console.log('choose month');
	  api.getindex().then(ui.getindexSuccess).catch(ui.failure);
	...
	var createGame = function createGame(event) {
	  ...
	  api.postgame(data).then(ui.postgameSuccess).catch(ui.failure);
	  $('#MonthModal').modal('hide');
	  $('#CategoryModal').modal('hide');
	  $('#RatingModal').modal('hide');
	...
	var updateGame = function updateGame(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  console.log('edited');
	  var id = $(event.target).data('id');
	  api.updategame(data, id).then(ui.updategameSuccess).catch(ui.failure);
	  $('#MonthModal').modal('hide');
	  $('#CategoryModal').modal('hide');
	  $('#RatingModal').modal('hide');
	};
	...
	var deleteGame = function deleteGame(event) {
	  ...
	  var id = $(event.target).data('id');
	  api.deletegame(id).then(ui.deletegameSuccess).catch(ui.failure);
	  $('#MonthModal').modal('hide');
	  $('#CategoryModal').modal('hide');
	  $('#RatingModal').modal('hide');
	};
